...
1. Já a escolha do banco de dados(MongoDB) se deu porque os requisitos apresentados tinha um grau de preocupação com a segurança da informação, mas não com a necessidade de recuperação em caso de falha ou perca, seja por acidente ou criminosa. Nesse contexto escolhemos o MongoDB pensando em uma melhor performasse frente ao banco SQL.
